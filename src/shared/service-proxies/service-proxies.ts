...
export class CategoryServiceProxy {
     ...
     * @return Success
     */
    getHistory(name: string | undefined, description: string | undefined, isActive: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CategoryDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetHistory?";
        if (name === null)
    ...
    protected processGetHistory(response: HttpResponseBase): Observable<CategoryDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    addFile(input: FileParameter | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/services/app/Category/AddFile";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    deleteCategory(body: CategoryDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    getCategoryList(): Observable<SelectItemDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetCategoryList";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCategoryList(response: HttpResponseBase): Observable<SelectItemDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        return _observableOf<SelectItemDto[]>(null as any);
    }
    ...
    getCategory(id: number | undefined): Observable<CategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/Category/GetCategory?";
        if (id === null)
     ...
     * @return Success
     */
    addCategory(body: CategoryDto | undefined): Observable<number> {
    ...
    protected processAddCategory(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    updateProuductSubCategory(body: CategoryDto | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Category/UpdateProuductSubCategory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateProuductSubCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateProuductSubCategory(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<number>;
                }
            } else
    ...
    protected processUpdateProuductSubCategory(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    deleteProuductSubCategory(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Category/DeleteProuductSubCategory?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteProuductSubCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteProuductSubCategory(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processDeleteProuductSubCategory(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAll(name: string | undefined, description: string | undefined, isActive: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CategoryDtoPagedResultDto> {
...
export class CategoryDto implements ICategoryDto {
    ...
    oldThumbnailImagePath: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.oldThumbnailImagePath = _data["oldThumbnailImagePath"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["oldThumbnailImagePath"] = this.oldThumbnailImagePath;
        return data;
    }
